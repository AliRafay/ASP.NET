...
namespace Services
{
    public class LocalMailService : IMailService
    {
        ...
        public LocalMailService(IConfiguration c)
        ...
        {
            Debug.WriteLine($"Mail from {config["mailSettings:mailFromAddress"]} To {config["mailSettings:mailToAddress"]} by Local Mail Server");
